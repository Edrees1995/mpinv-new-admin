...
var Faq = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('mw_faq')];
    ...
    var Faq = _classThis = /** @class */ (function () {
        function Faq_1() {
            ...
            this.category = (__runInitializers(this, _answer_extraInitializers), __runInitializers(this, _category_initializers, void 0)); // general, buying, selling, renting
    ...
    __setFunctionName(_classThis, "Faq");
    (function () {
        ...
        _category_decorators = [(0, typeorm_1.Column)({ length: 50, nullable: true })];
