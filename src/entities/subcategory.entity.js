...
var Subcategory = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('mw_subcategory')];
    ...
    var Subcategory = _classThis = /** @class */ (function () {
        function Subcategory_1() {
            ...
            this.category_id = (__runInitializers(this, _slug_extraInitializers), __runInitializers(this, _category_id_initializers, void 0));
            this.description = (__runInitializers(this, _category_id_extraInitializers), __runInitializers(this, _description_initializers, void 0));
    ...
    (function () {
        ...
        _category_decorators = [(0, typeorm_1.ManyToOne)(function () { return category_entity_1.Category; }, function (category) { return category.subcategories; }), (0, typeorm_1.JoinColumn)({ name: 'category_id' })];
